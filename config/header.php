<?php
// config/header.php — ACTUALIZADO con rutas nuevas de aprendiz e instructor
...
<header class="header">
    ...
    <nav class="nav-bar">
        <div class="nav-bar-content">
            <div class="nav-left">
                <?php if (esAprendiz()): ?>
                    <button onclick="window.location.href='<?= htmlspecialchars(app_url('mod/aprendiz/index.php')) ?>'" class="nav-item menu-toggle-btn">Inicio</button>
                <?php elseif (esInstructor()): ?>
                    <button onclick="window.location.href='<?= htmlspecialchars(app_url('mod/instructor_dashboard.php')) ?>'" class="nav-item menu-toggle-btn">Inicio</button>
                <?php else: ?>
                ...
                <div class="menu-container">
                    ...
                    <div id="menu-dropdown" class="profile-menu">
                        ...
                        <a href="<?= htmlspecialchars(app_url('mod/aprendiz_horario.php')) ?>" class="profile-menu-item">
                            <i class="fas fa-calendar-week"></i> Mi Horario
                        </a>
                        <a href="<?= htmlspecialchars(app_url('mod/aprendiz_compañeros.php')) ?>" class="profile-menu-item">
                            <i class="fas fa-users"></i> Mis Compañeros
                        </a>
                        <a href="<?= htmlspecialchars(app_url('mod/aprendiz_faltas.php')) ?>" class="profile-menu-item">
                            <i class="fas fa-calendar-times"></i> Mis Faltas
                        </a>
                        ...
                        <div class="profile-menu-footer"><span>© 2026 DTD</span></div>
                    </div>
                </div>
            </div>
...
#menu-dropdown { position:absolute; top:45px; left:0; width:250px; z-index:1000; }
</style>