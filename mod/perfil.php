<?php
// mod/perfil.php — Perfil completo con info según rol
session_start();
...
$rolLabel = match($rolUsuario) {
    'admin'      => ['label' => 'Administrador', 'color' => '#dc2626',   'icon' => 'fa-shield-halved'],
    'instructor' => ['label' => 'Instructor',    'color' => '#3b82f6',   'icon' => 'fa-chalkboard-teacher'],
    'aprendiz'   => ['label' => 'Aprendiz',      'color' => '#39a900',   'icon' => 'fa-user-graduate'],
    default      => ['label' => ucfirst($rolUsuario), 'color' => '#64748b', 'icon' => 'fa-user'],
};
?>
<!DOCTYPE html>
<html lang="es">
