...
<head>
    ...
    <title>Editar Regional - DTD SENA</title>
...
<body>
    ...
    <main class="container" id="contenido-principal" style="display:none; opacity:0;">
        <div class="form-container">
            <div class="form-header">
                ...
                <p>Actualice los datos de la regional SENA</p>
            </div>
                ...
                <div class="card-body">
                    <form id="form-regional">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nombre" value="<?= htmlspecialchars($regional['NOMBRE']) ?>" required>
                        </div>
                        <div class="form-group">
                            <label><i class="fas fa-barcode"></i> Código</label>
                            <input type="text" class="form-control" name="codigo" value="<?= htmlspecialchars($regional['CODIGO'] ?? '') ?>">
                        </div>
                        <div class="form-group">
                            <label><i class="fas fa-city"></i> Ciudad</label>
                            <input type="text" class="form-control" name="ciudad" value="<?= htmlspecialchars($regional['CIUDAD'] ?? '') ?>">
                        </div>
                        <div class="form-group">
                            <label><i class="fas fa-map-pin"></i> Dirección</label>
                            <input type="text" class="form-control" name="direccion" value="<?= htmlspecialchars($regional['DIRECCION'] ?? '') ?>">
                        </div>
                        <div class="form-group">
                            <label><i class="fas fa-phone"></i> Teléfono</label>
                            <input type="text" class="form-control" name="telefono" value="<?= htmlspecialchars($regional['TELEFONO'] ?? '') ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-actions">
                            <a href="../regional_detalle.php?id=<?= $id ?>" class="btn-cancel"><i class="fas fa-times"></i> Cancelar</a>
    ...
    <script>
        document.getElementById('form-regional').addEventListener('submit', function(e) {
            ...
            fetch('guardar_regional.php', { method: 'POST', body: formData })
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            ...
                            window.location.href = '../regional_detalle.php?id=<?= $id ?>';
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
